...
describe("Ehiogie Offer Content V2 parity", () => {
  ...
  it("calculates deterministic iframe grow/shrink, body margin, fallback and minimum height", () => {
    expect(calculateTarifIframeHeight(stubDoc({ rootBottom: 1500, marginBottom: "24px", docScroll: 1500, bodyScroll: 1500 }))).toBe(1524);
    expect(calculateTarifIframeHeight(stubDoc({ rootBottom: 900, marginBottom: "24px", docScroll: 1500, bodyScroll: 1500 }))).toBe(924);
