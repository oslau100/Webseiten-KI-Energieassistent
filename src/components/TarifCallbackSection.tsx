...
export const TarifCallbackSection=()=>{
 ...
 const avatarUrl=getText("sections.about.avatar_url","",lang);const personName=getText("sections.about.person_name","",lang);const[avatarReady,setAvatarReady]=useState(Boolean(avatarUrl));
