...
export function PortalShell({ children, title, onLogout }: { children: React.ReactNode; title: string; onLogout: () => void }) {
  ...
  return <PublicAffiliateShell><div className="border-b bg-muted/40"><div className="container px-4 py-4 flex gap-2 overflow-x-auto" aria-label={c("program")}>
    ...
    <Button variant="ghost" size="sm" onClick={onLogout}>{c("logout")}</Button>
