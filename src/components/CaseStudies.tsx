    ...
    <section className="relative bg-[#000000] py-20 overflow-hidden border-t border-white/5">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-6xl">
        ...
        <div className="flex justify-center mt-12 md:mt-16">
          <Button 
            size="lg" 
            className="bg-primary text-primary-foreground hover:bg-primary/90 text-base md:text-lg font-bold px-8 py-6 rounded-md shadow-[0_0_20px_rgba(255,255,255,0.1)] transition-all hover:scale-105"
            asChild
          >
