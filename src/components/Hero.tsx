...
export const Hero = () => {
  ...
  const heroWidgetId = getText("integrations.google_reviews.hero_widget_id", "");
  const validHeroWidgetId = getValidReviewWidgetId(heroWidgetId);
