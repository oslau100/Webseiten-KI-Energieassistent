export const affiliateCopy = {
  de: {
    ...
    forgot: "Passwort vergessen?", noAccount: "Noch kein Konto?", haveAccount: "Du hast bereits ein Konto?", neutralError: "Das hat leider nicht funktioniert. Bitte versuche es später erneut.", unavailableError: "Diese Funktion ist derzeit nicht verfügbar. Bitte versuche es später erneut.", passwordMismatch: "Die Passwörter stimmen nicht überein. Bitte überprüfe deine Eingabe.",
    loginSuccess: "Du wurdest erfolgreich angemeldet.", registerSuccess: "Dein Konto wurde erfolgreich erstellt.",
