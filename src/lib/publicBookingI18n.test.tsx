...
describe("booking translations",()=>{
 ...
 it("provides the selected date label in all twelve languages",()=>{const expected={de:"Ausgewähltes Datum",en:"Selected date",tr:"Seçilen tarih",ru:"Выбранная дата",ar:"التاريخ المحدد",it:"Data selezionata",zh:"已选日期",hi:"चुनी गई तारीख",es:"Fecha seleccionada",fr:"Date sélectionnée",nl:"Geselecteerde datum",pl:"Wybrana data"};for(const lang of langs)expect(bookingTranslations[lang].selectedDate).toBe(expected[lang as keyof typeof expected]);});
