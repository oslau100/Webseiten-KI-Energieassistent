...
const dictionaries: Record<LangCode, Dictionary> = {
  ...
  ar: {
    cta_check_savings: "تحقق من التوفير الآن", header_check_bill: "تحقق من الفاتورة السنوية للطاقة", header_check_savings: "تحقق من توفير التعرفة", hero_badge: "أكثر من 2,000 مستخدم راضٍ في جميع أنحاء ألمانيا", hero_headline: "هل تدفع أكثر من اللازم مقابل الكهرباء أو الغاز؟", hero_subline_prefix: "اكتشف ذلك خلال", hero_subline_emphasis: "60 ثانية فقط", hero_subline_suffix: ". يقوم مساعد الطاقة الرقمي بتحليل مئات التعرفات تلقائياً، ويستبعد العروض المضللة والمزوّدين ذوي المخاطر، ثم يعرض لك توصية موثوقة مع توفير حقيقي.", hero_result_note: "النتيجة خلال 60 ثانية - مجاناً 100٪", footer_contact: "التواصل", footer_callback: "حجز مكالمة", footer_legal: "قانوني", footer_privacy: "الخصوصية", footer_imprint: "بيانات النشر", footer_rights: "جميع الحقوق محفوظة.", cookie_title: "إعدادات الخصوصية", cookie_copy_1: "نستخدم ملفات تعريف الارتباط الأساسية للتشغيل وملفات التسويق فقط بموافقتك.", cookie_copy_2: "يمكنك تغيير اختياراتك في أي وقت. افتراضيًا يتم تفعيل الملفات الأساسية فقط.", cookie_marketing: "تسويق", cookie_essential: "أساسي", cookie_save: "حفظ الإعدادات", cookie_accept_all: "قبول الكل", callback_title: "حجز مكالمة"
  },
  it: {
