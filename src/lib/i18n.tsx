...
const statusPageDictionaries: Record<LangCode, Dictionary> = {
  de: {
    ...
    status_invoice_error_title: "Da ist etwas schiefgelaufen",
    status_invoice_error_body: "Deine Rechnungsprüfung konnte gerade nicht vollständig übermittelt werden. Bitte versuche es in wenigen Minuten erneut.",
    status_invoice_error_hint: "Falls der Fehler weiterhin auftritt, kontaktiere uns bitte direkt – wir helfen dir weiter.",
    status_invoice_error_cta: "Zurück zur Rechnungsprüfung",
    status_invoice_error_home: "Zur Startseite",
  },
  en: {
