...
export const affiliateApi = {
  login: (email: string, password: string) => request<void>("/api/auth/sign-in/email", { method: "POST", body: JSON.stringify({ email, password }) }),
  register: (name: string, email: string, password: string) => request<void>("/api/auth/sign-up/email", { method: "POST", body: JSON.stringify({ name, email, password }) }),
  forgotPassword: (email: string) => request<void>("/api/auth/forget-password", { method: "POST", body: JSON.stringify({ email }) }),
